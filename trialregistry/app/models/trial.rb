class Trial < ActiveRecord::Base
  ...
  #has_many :subjects
  attr_accessible :extId, :description, :recruitingTarget, :recruiting_status, :prenameInvestigator, :surnameInvestigator, :mailInvestigator, :informed_consent, :activated
  before_create do |trial|
    trial.recruiting_status = 0
  end
  
  validates :extId, :description, :presence => true
